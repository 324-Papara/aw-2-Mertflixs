...
{
    public class CostumerValidator : AbstractValidator<Customer>
    {
        public CustomerValidator()
        {
            RuleFor(x => x.FirstName)
                .NotEmpty()
                .Length(3, 15)
                .WithMessage("First name length must be between 3-15 chracters!");
            RuleFor(x => x.LastName)
                .NotEmpty()
                .Length(1, 15)
                .WithMessage("Last name length must be between 1-15 chracters!");
